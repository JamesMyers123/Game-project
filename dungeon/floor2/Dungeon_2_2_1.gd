...
func _on__1_room_1_transition_body_entered(body):
	get_tree().change_scene_to_file("res://dungeon/floor2/Dungeon_2_Floor_3_room1.tscn")
	PlayerState.scene = "res://dungeon/floor2/Dungeon_2_Floor_3_room1.tscn"
	PlayerState.pos = Vector2(450,625)
...
func _on_exit_body_entered(body):
	...
	PlayerState.pos = Vector2(103,10)
